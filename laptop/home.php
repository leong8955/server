...
<body>
	...
	<button type = "button" onclick="location.href='withdraw.php'" >Withdraw Money.</button>
        <button type = "button" onclick="location.href='transfer.php'" >Transfer Money.</button>
	<button type = "button" onclick="location.href='balance.php'" >Check Balance.</button>
        <button type = "button" onclick="location.href='transaction.php'" >View Transaction.</button>
    </div>
</body>
</html>